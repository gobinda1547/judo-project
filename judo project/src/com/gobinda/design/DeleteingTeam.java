...
public class DeleteingTeam extends JFrame {
	...
	public DeleteingTeam() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				boolean ans = MainFrame.teamManager.deleteTeam(s1, s2);

				if (!ans) {
					lbl.setText("Team Not Found!");
					return;
				}
				lbl.setText("Successfully deleted");
				vn.setText("");
				tn.setText("");
				All.tv.repaint();
			}
		...
		btnCancel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				MainFrame.deleteingTeam.setVisible(false);
			}
		});
